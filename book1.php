      ...
      <div class="wrapper">
              ...
              <div class="form">
                <div class="inputfield">
                    <label style="white-space:nowrap">Select Time <br>Slot :</label>
              ...
              <div class="inputfield">
                  ...
                  <input type="date" name="date" onclick="validDate()" id='date' required >
              </div>
              
              <div class="inputfield">                 
                    <label style="white-space:nowrap">Select Type of<br>Servicing :</label>
                    <input type="radio" name="op" class="radio" value="Full" required >Full Servicing (Service,Oil,Washing,etc.) <br>
                    <input type="radio" name="op" class="radio" value="Half" required >Half Servicing (Service,Oil,etc.)
                </div>
